...
function Header() {
  return (
    <div className="flex justify-center items-center px-16 py-6 bg-slate-100 max-md:px-5">
      <div className="flex gap-5 justify-between items-center w-full max-w-[1215px] max-md:flex-wrap max-md:max-w-full">
        <div className="flex gap-2 self-stretch my-auto">
          ...
          <img
            ...
            className="shrink-0 my-auto max-w-full aspect-[5.56] fill-gray-800 w-[111px]"
          />
        </div>
        <div className="flex gap-5 justify-center self-stretch my-auto text-base leading-6 whitespace-nowrap text-zinc-900 max-md:flex-wrap max-md:max-w-full">
        ...
        <div className="flex gap-3.5 self-stretch text-sm font-medium leading-5 text-center">
          <div className="justify-center px-5 py-2.5 text-green-500 whitespace-nowrap rounded-md bg-slate-100">
            Login
          </div>
